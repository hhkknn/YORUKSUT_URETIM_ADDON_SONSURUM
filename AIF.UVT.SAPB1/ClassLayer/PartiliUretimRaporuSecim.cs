...
{
    public class PartiliUretimRaporuSecim
    {
        [ItemAtt(AIFConn.PartiliUretimRaporuSecimUID)]
        ...
        public void LoadForms()
        {
            ...
            ConstVariables.oFnc.LoadSAPXML(AIFConn.PartiliUretimRaporuSecimXML, Assembly.GetExecutingAssembly().GetManifestResourceStream(AIFConn.PartiliUretimRaporuSecimXML));
            Functions.CreateUserOrSystemFormComponent<PartiliUretimRaporuSecim>(AIFConn.UretimSecm);
