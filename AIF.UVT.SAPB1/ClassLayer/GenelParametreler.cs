...
namespace AIF.UVT.SAPB1.ClassLayer
{
    public class GenelParametreler
    {
        ...
        [ItemAtt("Item_1")]
        public SAPbouiCOM.ComboBox cmbUretimYonetimSekli;
        public void LoadForms()
        {
            ...
            Functions.CreateUserOrSystemFormComponent<GenelParametreler>(AIFConn.GenelParam);
        ...
        public void InitForms()
        {
            try
            {
                frmGenelParametreler.EnableMenu("1283", false);
                frmGenelParametreler.EnableMenu("1284", false);
                frmGenelParametreler.EnableMenu("1286", false);
                ...
                string sql = "";
                sql = "Select \"DocEntry\" from \"@AIF_UVT_PARAM\"";
